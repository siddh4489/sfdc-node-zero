...
client.controller('CostAllocationComponentController',[
...
// 		    var errorMessages = [];
		...
		$scope.loadInvoiceLineItems = function(){
			...
			$scope.amountFieldName=$appCache.get('CostAllocationComponent_'+$scope.section.Component.parent+'_amountFieldName');
			$scope.childAmountFieldName=$appCache.get('CostAllocationComponent_'+$scope.section.Component.child+'_childAmountFieldName');
			$scope.othercharageFieldName=$appCache.get('CostAllocationComponent_'+$scope.section.Component.child+'_othercharageFieldName');
			$scope.invoicelookupFieldName=$appCache.get('CostAllocationComponent_'+$scope.section.Component.child+'_invoicelookupFieldName');
					...
					if(response.success === true){
						...
						.success(function(response){
							if(response.success === true){
								...
								$appCache.put('CostAllocationComponent_'+$scope.section.Component.parent+'_amountFieldName', $scope.amountFieldName);
								...
								$appCache.put('CostAllocationComponent_'+$scope.section.Component.child+'_childAmountFieldName', $scope.childAmountFieldName);
								$appCache.put('CostAllocationComponent_'+$scope.section.Component.child+'_othercharageFieldName', $scope.othercharageFieldName);
								$appCache.put('CostAllocationComponent_'+$scope.section.Component.child+'_invoicelookupFieldName', $scope.invoicelookupFieldName);
