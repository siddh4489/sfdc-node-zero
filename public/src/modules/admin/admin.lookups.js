    ...
    return {
        sObject: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-lookups/sobject.html',
        ...
        sObjectLayout: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-lookups/sobjectlayout.html',
        ...
        sObjectLookup: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-lookups/sobjectlookup.html',
        ...
        tab: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-lookups/tab.html',
        ...
        icon: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-lookups/icon.html',
        ...
        role: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-lookups/role.html',
        ...
        language: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-lookups/language.html',
