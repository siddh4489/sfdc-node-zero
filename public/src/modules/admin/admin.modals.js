    ...
    return {
        layoutSectionProperties: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/layoutsectionproperties.html',
        ...
        relatedListProperties: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/layoutrelatedlistproperties.html',
        ...
        layoutFieldProperties: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/layoutfieldproperties.html',
        ...
        criteriaModal: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/criteriamodal.html',
        ...
        multiObjectCriteriaModal: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/multiobjectcriteriamodal.html',
        ...
        layoutFieldPropertiesPicklistValues: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/layoutfieldproperties_picklistvalues.html',
        ...
        adminClientDashboardContainerProperties: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/dashboardcontainerproperties.html',
        ...
        adminClientDashboardContainerComponentProperties: function(data, callback){
            ModalService.showModal({
                templateUrl: 'views/admin/admin-modals/dashboardcontainercomponentproperties.html',
